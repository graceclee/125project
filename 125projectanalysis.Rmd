...
SATCLEANED[SATCLEANED < 0] <- NA

SATCLEANED = drop_na(SAT_ACT)
#SAT_ACT = SAT_ACT[SAT_ACT$SA_Male != -9,]
#SAT_ACT = SAT_ACT[SAT_ACT$SA_Female != -9,]
...
#joined_data <- inner_join(credit_recovery,schools_only, by=c("School", "District"))
# 1311 rows

#joined_data <- inner_join(joined_data,d_enrollment, by=c("School", "District"))
# 637 rows

# joined_data <- inner_join(gift_talent,schools_only, by=c("School", "District"))
# summary(joined_data)
# 917 rows

#joined_data <- inner_join(characteristics,schools_only,by=c("School", "District"))
#summary(joined_data)
# length 1669 

#joined_data <- inner_join(expenditures,schools_only,by=c("School", "District"))
#joined_data <- inner_join(joined_data, characteristics, by=c("School", "District"))
